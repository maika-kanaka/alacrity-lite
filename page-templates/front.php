    ...
    line-height: 40px;
        ...
        <h2 class="sec-title"><?php printf( '<a href="https://migunesia.com/tentang-migunesia">%s</a>', esc_html( get_the_title() ) );?></h2>
                ...
                <div class="col_right_eq col_2">
                        ...
                        <iframe height="315" src="https://www.youtube.com/embed/CGzRdwi7Yd0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
                </div>
            </div>
